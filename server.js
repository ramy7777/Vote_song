...
let songs = [
    ...
    { id: 49, name: 'APT - ROSÉ & Bruno Mars', file: 'ROSÉ & Bruno Mars - APT..mp3', votes: 0 },
    ...
    { id: 55, name: 'Bitter Sweet Symphony - The Verve', file: 'The Verve - Bitter sweet symphony .mp3', votes: 0 },
    { id: 56, name: 'Flowers - Miley Cyrus', file: '[YT2mp3.info] - Miley Cyrus - Flowers (Official Video) (320kbps).mp3', votes: 0 },
    { id: 57, name: 'Wish You Were Here - Pink Floyd', file: 'wish you were here.mp3', votes: 0 },
    ...
    { id: 63, name: 'Thunder (Lyrics) - Imagine Dragons', file: 'yt1s.com - Imagine Dragons  Thunder Lyrics.mp3', votes: 0 }
